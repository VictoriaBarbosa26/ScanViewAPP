...
import { StyleSheet, View, Text, TouchableOpacity, Image, ScrollView, Modal, TextInput, Platform } from 'react-native';
import { LinearGradient } from 'expo-linear-gradient';
import { useNavigation } from '@react-navigation/native';
import { db } from '../../../../config/firebaseConfig';
import { collection, addDoc, Timestamp, doc, getDoc } from 'firebase/firestore'; // Importação para consultar Firestore
...
const ViewProblemsScreen = ({ route, navigation }) => {
  ...
  // Estados para armazenar informações do usuário logado
  ...
  useEffect(() => {
    ...
    getUserInfo(); // Obtém as informações do usuário logado
  ...
  const submitResolvedProblem = async () => {
    ...
    try {
      ...
      // Redirecionando para a tela "ProblemaResolvidoADM" após o envio bem-sucedido
      navigation.navigate('ProblemaResolvidoADM');
    } catch (error) {
