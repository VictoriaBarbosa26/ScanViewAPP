// ESCOLHA DE LABORATORIO PARA O CURSO DE ADM
    ...
    <View style={styles.container}>
      ...
      <LinearGradient colors={['#0056b3', '#000000']} style={styles.boxesContainer}>
        ...
        <View style={styles.columnContainer}>
          {/* Container para as duas primeiras caixas */}
          <View style={styles.rowContainer}>
            {/* Primeiro bloco com o texto "Laboratório" e botão numerado */}
            <View style={styles.boxContainer}>
              <Text style={styles.boxText}>Laboratório</Text>
              <TouchableOpacity style={styles.box} onPress={() => navigation.navigate('RecadoMT_AUT')}>
            ...
            {/* Segundo bloco com o texto "Laboratório" e botão numerado */}
            <View style={styles.boxContainer}>
              <Text style={styles.boxText}>Laboratório</Text>
              <TouchableOpacity style={styles.box} onPress={() => navigation.navigate('RecadoMT_AUT')}>
          ...
          {/* Container para a terceira caixa, centralizada abaixo */}
          <View style={styles.centeredContainer}>
            {/* Terceiro bloco com o texto "Laboratório" e botão numerado */}
            <View style={styles.boxContainer}>
              <Text style={styles.boxText}>Laboratório</Text>
              <TouchableOpacity style={styles.box} onPress={() => navigation.navigate('RecadoMT_AUT')}>
...
const styles = StyleSheet.create({
  ...
  rowContainer: {
    flexDirection: 'row',  // Alinha as caixas horizontalmente
    justifyContent: 'space-between',  // Espaçamento igual entre as caixas
    width: '100%',  // Largura total da tela
    alignItems: 'center',  // Centraliza as caixas verticalmente
  },
  centeredContainer: {
    marginTop: 20,  // Espaçamento acima da terceira caixa
    alignItems: 'center',  // Centraliza a terceira caixa horizontalmente
  },
  boxContainer: {
    alignItems: 'center',  // Centraliza o texto e o botão
    width: '40%',  // Cada caixa ocupa 40% da largura disponível
  },
  box: {
