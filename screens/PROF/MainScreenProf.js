  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient colors={['#003185', '#000000']} style={styles.boxesContainer}>
        ...
        <View style={styles.row}>
          <View style={styles.boxContainer}>
            <TouchableOpacity style={styles.box} onPress={() => navigation.navigate('RelatarProProf')}>
              <Image style={styles.boxImage} source={require('../../assets/relatar.png')} />
            </TouchableOpacity>
            <Text style={styles.boxText}>Relatar Problemas</Text>
          </View>
          <View style={styles.boxContainer}>
            <TouchableOpacity style={styles.box} onPress={() => navigation.navigate('RegistroAlunos')}>
              <Image style={styles.boxImage} source={require('../../assets/agendamento.png')} />
            </TouchableOpacity>
            <Text style={styles.boxText}>Registro dos Alunos</Text>
          </View>
        </View>
        ...
        <View style={styles.row}>
          <View style={styles.boxContainer}>
            <TouchableOpacity style={styles.box} onPress={() => navigation.navigate('RegistroAula')}>
              <Image style={styles.boxImage} source={require('../../assets/historico.png')} />
            </TouchableOpacity>
            <Text style={styles.boxText}>Registro de Aulas</Text>
          </View>
          <View style={styles.boxContainer}>
            <TouchableOpacity style={styles.box} onPress={() => navigation.navigate('HorarioDispADM')}>
              <Image style={styles.boxImage} source={require('../../assets/horarios.png')} />
            </TouchableOpacity>
            <Text style={styles.boxText}>Horário de Disponibilidade dos ADM</Text>
          </View>
        </View>
      </LinearGradient>
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity style={styles.bottomOption} onPress={() => navigation.navigate('MainEmailProf')}>
